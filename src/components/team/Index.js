...
const Index = () => {
  ...
  return (
    ...
    <Header/>
      <div>
        ...
        <div className={styles.margin}>
          <Heads pos1="Faculty Coordinator" pos2= "Faculty Coordinator" pos3="President" pos4="Vice President"
          name1="Dr. Pushpdant Jain" name2="Dr. Yogesh Shukla" name3="Bhaibhav Raj" name4="Shantanu Singh"
           pic1={fc1} pic2={fc2} pic3={president} pic4={vp1}/>
     ...
     {/* Web and app collapse button  */}
      ...
      <Members pos1="Lead" pos2= "Co-Lead" 
      name1="Kshitij Singh" name2="Smarani Basu" 
      pic1={WL} pic2={WcL}  />
        
      <Members pos1="Member" pos2="Member"
      name1="Aryan Rana" name2="Manomay Kagalkar" 
      pic1={wm1} pic2={wm2} />
        
      <Members pos1="Member" pos2="Member"
      name1 = "Devyanshu Gagneja" name2="Shourya Srivastav" 
      pic1={wm3} pic2={wm4} />

      <Members pos1="Member" pos2="Member"
      name1="Simran Gupta" name2= "Vikash Sinha" 
      pic1={wm5} pic2={wm6} />
      
      <Members pos1="Member" pos2="Member"
      name1="Neelesh Ranjan" name2="Om Kumar Mishra"
      pic1={wm7} pic2={wm8} />
     ...
     <div className={`${styles.marginTop}`}>
        ...
        {!show && <span>
          ...
          <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Ananya Maitrayi Jha" name2="Arindam Goswami" 
        pic1={PCL} pic2={PCcL}  />
        
        <Members pos1="Member" pos2="Member"
        name1="Atharv Sathe" name2="Divyansh Chaturvedi" 
        pic1={pcm1} pic2={pcm2} />
        
       <Members pos1="Member" pos2="Member"
       name1 = "Harshita Nimje" name2="Reet Tejankar" 
        pic1={pcm3} pic2={pcm4} />
   ...
   <div className={`${styles.marginTop}`}>
        ...
        {!show && <span>
          ...
          <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Aashay Kulkarni" name2="Harsh Saand" 
        pic1={CEL} pic2={CEcL}  />
        
        <Members pos1="Member" pos2="Member"
        name1="Aalap Ghanekar" name2="Astha Tripathi" 
        pic1={cem1} pic2={cem2} />
        
       <Members pos1="Member" pos2="Member"
       name1 = "Harsh Shukla" name2="Ankit Rane" 
        pic1={cem3} pic2={cem4} />
      
      <Members pos1="Member" pos2="Member"
      name1 = "Atharv Pal" name2="Divij Ganjoo" 
      pic1={cem5} pic2={cem6}  />
   ...
   <div className={`${styles.marginTop}`}>
        ...
        {!show && <span>
          ...
          <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Hemal Shingloo" name2="Ayushi Agarwal" 
        pic1={ML} pic2={McL}  />
        
        <Members pos1="Member" pos2="Member"
        name1="Anisha Khandelwal" name2="Archit Kumar" 
        pic1={mm1} pic2={mm2} />
        
       <Members pos1="Member" pos2="Member"
       name1 = "Prakriti Suman" name2="Sourav Makur" 
        pic1={mm3} pic2={mm4} />
  ...
  {/* Hospitality Team */}
      ...
      <div className={`${styles.marginTop}`}>
        ...
        {!show && <span>
          ...
          <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Rishita Yadav" name2="Sanya Bhambhani" 
        pic1={HL} pic2={HcL}  />
        
        <Members pos1="Member" pos2="Member"
        name1="Aviral Dwivedi" name2="Muskan Pande" 
        pic1={hm1} pic2={hm2} />
        
       <Members pos1="Member" pos2="Member"
       name1 = "Mudita Pathak" name2="Aryaman Gupta" 
       pic1={hm3} pic2={hm4} />
      ...
      <div className={`${styles.marginTop}`}>
        ...
        <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Harsh Parmar" name2="Khatri Likhita " 
        pic1={RL} pic2={RcL}  />
        
        <Members pos1="Member" pos2="Member"
        name1="Anay Verma" name2="Amritraj Singh Gurudatta" 
        pic1={rm1} pic2={rm2} />
        
       <Members pos1="Member" pos2="Member"
       name1 = "Abhijeet Humar Sharma" name2="R.Simran Nair" 
       pic1={rm3} pic2={rm4} />
  ...
  <div className={`${styles.marginTop}`}>
        ...
        <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Gourav Makur" name2="Swanand Deshpande" 
        pic1={VL} pic2={VcL}  />
        
        <Members pos1="Member" pos2="Member"
        name1="Satyam Kumar Singh" name2="Saurav Kumar" 
        pic1={vm1} pic2={vm2} />
        
       <Members pos1="Member" pos2="Member"
       name1 = "Sharran Sanar" name2="Ajinkya Fulpatil" 
       pic1={vm3} pic2={vm4} />

      <Members pos1="Member" pos2="Member" 
       name1 = "Jatin Singh" name2="Akshay Syam"
       pic1={vm5} />
...
{/* Production ad Design Team  */}
   ...
   <div className={`${styles.marginTop}`}>
        ...
        <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Arun Thomas" name2="Samyak Maitre" 
        pic1={DL} pic2={DcL}  />
        
        <Members pos1="Member" pos2="Member"
        name1="Ruchika Roy" name2="Vagdevi Mangi" 
        pic1={dm2} pic2={dm3} />
...
<div className={`${styles.marginTop}`}>
        ...
        <Members pos1="Lead" pos2= "Co-Lead" 
        name1="Harshit Singh" name2="Ritindrananth Tagore" 
        pic1={SL} pic2={ScL} />
        
        <Members pos1="Member" pos2="Member"
        name1="Yesh Singh" name2="Sawari Jamgaonkar" 
        pic1={sm1} pic2={sm2} />
        
       <Members pos1="Member" pos2="Member"
       name1 = "Aryan Saklani" name2="Vaibhav Goswami" 
       pic1={sm3} />
        </div> 
        </span>}
      </div>
