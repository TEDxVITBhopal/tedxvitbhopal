...
import "./blogPage.css";
import BlogImage from "../../resources/dark-space-bg.png";

const BlogPage = () => {
    return(
        <>
            <div className="blog-title">
                <h1 className="title-style">Introductory Article</h1>
                <h5 className="by-line">By Akshay Kumar</h5>
            </div>
